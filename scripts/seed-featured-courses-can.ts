/**
 * Seed Featured Courses Script — Canada
 *
 * Imports ~40 popular Canadian golf courses via GolfAPI.io and marks them
 * as featured so the Courses tab feels populated for Canadian users.
 *
 * Usage:
 *   npx tsx scripts/seed-featured-courses-can.ts
 *
 * Prerequisites:
...
// =====================================================
// CURATED FEATURED CLUB LIST BY PROVINCE
// =====================================================

interface FeaturedClubEntry {
  name: string;
  /** Province — stored in the `state` column for consistent filtering */
  region: string;
}

const FEATURED_CLUBS: FeaturedClubEntry[] = [
  // ── Ontario (~12 clubs) ────────────────────────────
  { name: 'Glen Abbey Golf Club', region: 'Ontario' },
  { name: 'St. George\'s Golf and Country Club', region: 'Ontario' },
  { name: 'National Golf Club of Canada', region: 'Ontario' },
  { name: 'Hamilton Golf & Country Club', region: 'Ontario' },
  { name: 'Devil\'s Pulpit Golf Association', region: 'Ontario' },
  { name: 'TPC Toronto at Osprey Valley', region: 'Ontario' },
  { name: 'Angus Glen Golf Club', region: 'Ontario' },
  { name: 'Muskoka Bay Club', region: 'Ontario' },
  { name: 'Taboo Muskoka Resort', region: 'Ontario' },
  { name: 'Cobble Beach Golf Resort', region: 'Ontario' },
  { name: 'Whistle Bear Golf Club', region: 'Ontario' },
  { name: 'Cabot Cliffs', region: 'Ontario' },

  // ── British Columbia (~10 clubs) ───────────────────
  { name: 'Furry Creek Golf & Country Club', region: 'British Columbia' },
  { name: 'Fairmont Chateau Whistler Golf Club', region: 'British Columbia' },
  { name: 'Nicklaus North Golf Course', region: 'British Columbia' },
  { name: 'Morgan Creek Golf Course', region: 'British Columbia' },
  { name: 'Bear Mountain Golf Resort', region: 'British Columbia' },
  { name: 'Gallagher\'s Canyon Golf & Country Club', region: 'British Columbia' },
  { name: 'Predator Ridge Golf Resort', region: 'British Columbia' },
  { name: 'Tobiano Golf Course', region: 'British Columbia' },
  { name: 'Greywolf Golf Course', region: 'British Columbia' },
  { name: 'Big Sky Golf & Country Club', region: 'British Columbia' },

  // ── Alberta (~10 clubs) ────────────────────────────
  { name: 'Stewart Creek Golf & Country Club', region: 'Alberta' },
  { name: 'Silvertip Resort', region: 'Alberta' },
  { name: 'Kananaskis Country Golf Course', region: 'Alberta' },
  { name: 'Wolf Creek Golf Resort', region: 'Alberta' },
  { name: 'Dinosaur Trail Golf & Country Club', region: 'Alberta' },
  { name: 'Links of GlenEagles', region: 'Alberta' },
  { name: 'River Spirit Golf Club', region: 'Alberta' },
  { name: 'Mickelson National Golf Club', region: 'Alberta' },
  { name: 'Fairmont Banff Springs Golf Course', region: 'Alberta' },
  { name: 'Fairmont Jasper Park Lodge Golf Course', region: 'Alberta' },

  // ── Quebec (~8 clubs) ─────────────────────────────
  { name: 'Royal Montreal Golf Club', region: 'Quebec' },
  { name: 'Le Mirage Golf Club', region: 'Quebec' },
  { name: 'Tremblant Golf Resort', region: 'Quebec' },
  { name: 'Gray Rocks Golf Club', region: 'Quebec' },
  { name: 'Club de golf Le Fontainebleau', region: 'Quebec' },
  { name: 'Fairmont Le Manoir Richelieu Golf Club', region: 'Quebec' },
  { name: 'Camelot Golf & Country Club', region: 'Quebec' },
  { name: 'Club de golf Le Blainvillier', region: 'Quebec' },
];
...
async function upsertClub(club: GolfApiClubResponse, region: string): Promise<string> {
  ...
  const clubData = {
    ...
    state: region, // Province stored in state column
    country: 'Canada',
...
async function main() {
  console.log('Seeding featured Canadian golf courses...');
  ...
  console.log(`\nTotal featured Canadian clubs in database: ${count}`);
}
