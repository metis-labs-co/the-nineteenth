...
|------|-------------|------------|
| **Free** | Default for all users | 3 competitions, 1 league, 2 rounds, 5 social rounds, 5 friends, Stableford only |
| **Social** | Casual golfers | 8 competitions, 3 leagues, 5 rounds, 12 players, 15 friends, +Stroke Play, Match Play, team formats enabled, detailed stats, handicap history, achievement leaderboard, AI competition, guest management, GPS distance |
