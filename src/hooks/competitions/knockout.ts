/**
 * Competition Hooks - Knockout Bracket Hooks
 *
 * Query and mutation hooks for knockout tournament operations.
 *
 * Hooks:
 * - useKnockoutBracket: Fetch and organize bracket data
 * - useKnockoutMatch: Fetch a single match
 * - useGenerateBracket: Generate a new bracket
 * - useCompleteKnockoutMatch: Complete a match and advance winner
 * - useResetBracket: Reset the bracket
 */
