/**
 * Course Hooks - Favorite Course Management
 *
 * Centralized hook for favorite course management.
 *
 * Provides:
 ...
 * - useFavoriteEnrichment() - Helper to add is_favorite to course arrays
