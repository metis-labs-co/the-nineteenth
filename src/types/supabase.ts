  ...
  public: {
    Tables: {
      ...
      pool_transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "pool_transactions_round_id_fkey"
            columns: ["round_id"]
            isOneToOne: false
            referencedRelation: "rounds"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      auto_split_pool_for_skins: {
        Args: { p_pool_id: string; p_round_count: number }
        Returns: undefined
      }
      award_achievement: {
        Args: {
      ...
      calculate_skins_remaining_carryover: {
      ...
      can_draw_from_pool: {
        Args: { p_amount: number; p_pool_id: string }
        Returns: boolean
      }
      ...
      draw_from_pool: {
        Args: { p_amount: number; p_pool_id: string; p_round_id: string }
        Returns: number
      }
      dropgeometrycolumn:
        | {
      ...
      get_pool_balance: {
        Args: { p_category?: string; p_pool_id: string }
        Returns: number
      }
      ...
      recalculate_pool_total: { Args: { p_pool_id: string }; Returns: number }
      return_to_pool: {
        Args: {
          p_amount: number
    ...
    Enums: {
      ...
      team_format: "best-ball" | "scramble" | "aggregate" | "match-play-team"
