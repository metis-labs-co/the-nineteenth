...
export { ScoringPairFormationUI, default as ScoringPairFormationUIDefault } from './ScoringPairFormationUI';
export type { ScoringPairFormationUIProps } from './ScoringPairFormationUI';
